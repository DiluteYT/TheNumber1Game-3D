...
std::vector<Vertex> Grass() {
	...
	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 1 FRONT

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 0.75f)); // 2

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 3

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 4

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 1.0f)); // 5

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 6

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 7 BACK

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 0.75f)); // 8

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 9

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 10

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 1.0f)); // 11

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 12

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 0.75f)); // 13 LEFT

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 1.0f)); // 14

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 15

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 1.0f)); // 16

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 0.75f)); // 17

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 18

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 19 RIGHT

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 1.0f)); // 20

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 0.75f)); // 21

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 22

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 0.75f)); // 23

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 1.0f)); // 24

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.0f, 0.75f)); // 25 TOP

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 26

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.0f, 1.0f)); // 27

	placeholder.emplace_back(glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.0f, 0.75f)); // 28

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 0.75f)); // 29

	placeholder.emplace_back(glm::vec3(0.5f, 0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.25f, 1.0f)); // 30

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 1.0f)); // 31 BOTTOM

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.75f, 1.0f)); // 32

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 33

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, -0.5f), glm::vec3(1.0f), glm::vec2(0.75f, 1.0f)); // 34

	placeholder.emplace_back(glm::vec3(0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.75f, 0.75f)); // 35

	placeholder.emplace_back(glm::vec3(-0.5f, -0.5f, 0.5f), glm::vec3(1.0f), glm::vec2(0.5f, 0.75f)); // 36
